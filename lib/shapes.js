...
function getShapeCenter(shape, axis, value, half) {
    ...
    // Verificar si la forma está en la mitad correcta para bloques de medio tamaño
    if (half) {
    ...
    // Verificar si la forma toca la cara
    const epsilon = 0.001;
    if (value > 0) {
    ...
    // Ajustar la coordenada en el eje de la cara
    if (value > 0) {
        center[axis] = 1;
    } else {
        center[axis] = 0;
...
// Funciones auxiliares para manejo de formas especiales
